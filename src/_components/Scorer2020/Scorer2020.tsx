...
import { ScorerContextProvider } from '../ScorerProvider';
        ...
        return (
            <Container fluid>
                <FormProvider {...methods}>
                    <ScorerContextProvider onChange={handleChange} tns="rg2020">
                            ...
                            <Accordion defaultActiveKey="01">
                                ...
                                <ScorerPanel mid="m09">
                                    <Row>
                                        ...
                                        <ButtonRadios
                                            qid="blueTyrePosition"
                                            values={['outside', 'onField', 'inArea']}
                                        />
                                        <ButtonRadios qid="blackTyreWhite" values={['no', 'yes']} />
                                        <ButtonRadios
                                            qid="blackTyrePosition"
                                            values={['outside', 'onField', 'inArea']}
                                        />
                                ...
                                <ScorerPanel mid="m12">
                                    <Row>
                                        <ButtonRadios
                                            qid="wheelPosition"
                                            values={['notOut', 'completelyOut', 'inSmall']}
                                        />
                                    </Row>
                                </ScorerPanel>
                                <ScorerPanel mid="m13">
